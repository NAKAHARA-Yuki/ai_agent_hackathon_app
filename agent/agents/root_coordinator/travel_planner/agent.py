...
TRAVEL_PLANNER_INSTRUCTION = (
	...
	"目標：利用者の興味/制約を反映し、選択可能な 3 案 (各: タイトル/タグ/短い説明/日別行程/主要スポット/任意ルート) を提示。地理的合理性と季節感・移動時間を考慮。危険/非現実/閉鎖施設除外。各行程には可能な限り『移動手段(transport)』と所要時間も含める。\n\n"
	...
	"拡張フィールド（transport）：\n- itinerary.items[].transport: { \"mode\": \"driving|walking|bicycling|transit\", \"estimated_duration\": string|null, \"distance_km\": number|null } | null\n- route_info.estimated_duration: string | null\n\n"
	"OK例 (単純化): {\"summary\":\"...\",\"plans\":[{\"title\":\"A\",\"tags\":[\"温泉\"],\"brief\":\"説明\",\"itinerary\":[{\"day\":1,\"items\":[{\"time\":\"09:00\",\"title\":\"スポット\",\"transport\":{\"mode\":\"transit\",\"estimated_duration\":\"15分\"}}]}],\"places\":[{\"name\":\"場所1\",\"lat\":35.0,\"lng\":139.0,\"note\":null}],\"route_info\":{\"origin\":\"羽田空港\",\"destination\":\"浅草\",\"waypoints\":[],\"mode\":\"transit\",\"estimated_duration\":\"45分\"},\"text\":\"...\"}, {...},{...}]}\n"
