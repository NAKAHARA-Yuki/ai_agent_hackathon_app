    ...
    <div className="flex-1 flex flex-col justify-between relative overflow-hidden h-screen bg-[#090b11]">
      ...
      <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-white/5 bg-[#090b11]/80 backdrop-blur-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xs font-bold text-white font-outfit truncate max-w-[150px]">
      ...
      <div className="flex border-b border-white/5 bg-[#090b11] px-6 py-2 gap-2">
        <button
          ...
          className={`flex-1 py-2 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 cursor-pointer transition-all ${
            activeTab === 'chat'
              ? 'bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-bold shadow-sm'
              : 'text-slate-500 bg-white/5 border border-transparent'
          }`}
        >
          ...
          <>
            ...
            {loading && (
              <div className="flex gap-3 max-w-[85%]">
                ...
                <div className="rounded-2xl px-4 py-3 text-xs bg-white/5 border border-white/5 text-slate-400 rounded-tl-none flex items-center gap-1.5">
          ...
          >
            {currentPlan?.text && (
              <div className="glass-panel rounded-2xl p-4 space-y-1">
                <h3 className="text-[10px] font-bold text-slate-400 tracking-wider">SUMMARY</h3>
                <p className="text-xs text-slate-300 leading-relaxed font-outfit whitespace-pre-wrap">{currentPlan.text}</p>
              </div>
            )}
              ...
              <div className="space-y-6 pl-4 border-l border-white/5 relative">
                {currentPlan.itinerary.map((day: any, dIdx: number) => (
                  <div key={dIdx} className="space-y-4 relative">
                    ...
                    <div className="font-bold text-xs text-white pl-2">Day {day.day || dIdx + 1}</div>
      ...
      {activeTab === 'chat' && (
        <div className="border-t border-white/5 bg-[#090b11] p-4 z-10 flex gap-2">
